...
function FichajesLiga() {
  return (
    <div className="min-h-screen bg-gradient-to-tr from-black to-green-500 text-white px-4 sm:px-6 py-6 flex flex-col">
      <HeaderLigas />
      <HeaderLigaEspaña />

      <nav className="flex flex-wrap gap-4 border-b border-neutral-800 pb-4 mb-6 text-sm text-gray-400 mt-7">
      ...
      <h2 className="text-xl sm:text-2xl font-bold mb-6">Últimos fichajes</h2>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
        <div className="bg-neutral-900 rounded-lg overflow-hidden hover:shadow-green-500/20 transition-all duration-300 border border-gray-700 hover:scale-[1.02]">
          ...
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Defensor</p>
              </div>
            </div>
            <img
        ...
        <div className="bg-neutral-900 rounded-lg overflow-hidden border hover:shadow-green-500/20 transition-all duration-300  border-gray-700 hover:scale-[1.02]">
          <div className="flex justify-between items-center px-4 py-2 border-b border-neutral-800 text-sm text-gray-300">
